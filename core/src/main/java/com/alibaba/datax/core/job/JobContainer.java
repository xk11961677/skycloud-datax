...
public class JobContainer extends AbstractContainer {
        ...
        try {
            ...
            if (!isDryRun) {
                ...
                if (!hasException) {
                    ...
                    //modify 1111111111
                    this.logStatistics(dataxResult);
                }
            }
        }
        return dataxResult;
    ...
    private DataxResult logStatistics(DataxResult result) {
        ...
        result.fillPropertiespublic(
                ...
                communication.getLongCounter(CommunicationTool.TOTAL_ERROR_RECORDS),
                communication.getLongCounter(CommunicationTool.TRANSFORMER_SUCCEED_RECORDS),
                communication.getLongCounter(CommunicationTool.TRANSFORMER_FAILED_RECORDS),
                communication.getLongCounter(CommunicationTool.TRANSFORMER_FILTER_RECORDS),
